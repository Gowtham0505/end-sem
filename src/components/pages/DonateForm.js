            ...
            <div className="page_inner_div" id="donate_grid">
                ...
                <Modal show={this.state.show} onHide={() => this.handleModal()} >
                    ...
                    <Modal.Body style={{ fontSize: "9px" }}>
                        ...
                        <p>
                        In this you can donate,ffhyju upto 9000rs only 
                            upto 3 times. The Donor hereby pledges to [Your Organization] the sum of [insert amount] or more, which as provided for herein is designated for the benefit of [Fund Name] Endowment.
                            Donor Purpose.
